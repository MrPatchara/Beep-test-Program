...
class MSFTApp:
    def __init__(self, root):
        ...
        self.update_protocol()
         ...
         # Add this code in the __init__ method of the MSFTApp class, right after initializing the main_frame
        ...
        self.menu_bar.add_cascade(label="How to use", menu=self.how_to_use_menu)
        self.how_to_use_menu.add_command(label="Thai version", command=self.show_how_to_use)

        # Contact Developer Menu
        self.contact_menu = tk.Menu(self.menu_bar, tearoff=0)
        self.menu_bar.add_cascade(label="Contact Developer", menu=self.contact_menu)
    ...
    # Create a popup window with contact information
        ...
        label = tk.Label(contact_window, text="Contact Developer", font=("Arial", 14), bg="#333333", fg="#FFFFFF")
        label.pack(pady=10)

        contact_info = "For inquiries, please email: developer@example.com"
